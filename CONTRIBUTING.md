...
Thank you for your interest in contributing to TXTDirect DNS.  
This guide helps make contributing to TXTDirect DNS simple and efficient for everyone.

### First contribution

If you are starting out contributing to TXTDirect DNS, there might be smaller scoped "starter issues" available:
[Current starter issues](https://github.com/txtdirect/dns/labels/starter%20issue)
...
As your time is precious and not all features might be in the scope of what the TXTDirect DNS wants to achieve, please open up an issue first.
